...
object PatternsCompat {
    ...
    const val IANA_TOP_LEVEL_DOMAINS = ("(?:"
            ...
            + "|express|e[cegrstu])"
            + "|(?:fage|fail|fairwinds|faith|Droid|fan|fans|farm|fashion|feedback|ferrero|film"
     ...
     */
    private const val EMAIL_ADDRESS_LOCAL_PART = "[" + EMAIL_CHAR + "]" + "(?:[" + EMAIL_CHAR + "\\.]{0,62}[" + EMAIL_CHAR + "])?"
